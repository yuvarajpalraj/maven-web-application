...
<body>
<h1 align="center">Welcome to Mithun Technologies - this for GitHub hook trigger for GITScm polling  whe the files changed in github after the commit the poll scm tigger automatically concept for the testing purpos Pipeline Scripted Way PROJECT    .....</h1>
